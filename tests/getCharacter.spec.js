...
describe('9 - Implemente os casos de teste da função `getCharacter`', () => {
  it('Verifica se a função `getCharacter` retorna o objeto do personagem corretamente.', () => {
    ...
    // Teste se o parâmetro não é Case Sensitive, ou seja,
    // independente de conter letras maiúsculas ou minúsculas retorna o mesmo objeto relativo a ele.
    ...
    expect(getCharacter('Alexander')).toBe(undefined);
  });
});
